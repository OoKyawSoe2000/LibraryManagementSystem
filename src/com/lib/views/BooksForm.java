...
public class BooksForm extends JFrame {
    ...
    if(callno.isEmpty() || name.isEmpty() || author.isEmpty() || publisher.isEmpty() || squantity.isEmpty()) {
    	JOptionPane.showMessageDialog(BooksForm.this,"Field must not be empty !");
    }else {
    	 int quantity=Integer.parseInt(squantity);
			int i =dao.save(callno, name, author, publisher, quantity);
			if(i>0){
