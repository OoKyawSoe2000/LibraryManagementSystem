	...
	public IssueBookForm() {
		...
		btnIssueBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (dao.checkBook(bookcallno)) {

					if (bookcallno.isEmpty() || studentid.isEmpty() || studentname.isEmpty()
							|| studentcontact.isEmpty()) {

						JOptionPane.showMessageDialog(IssueBookForm.this, "Fields must not be empty !");
					} else {
						int stuId = Integer.parseInt(studentid);
						int i = dao.save(bookcallno, stuId, studentname, studentcontact);
						if (i > 0) {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
						.createSequentialGroup().addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(lblStudentName, GroupLayout.PREFERRED_SIZE, 108,
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane
						.createParallelGroup(Alignment.BASELINE).addComponent(lblStudentId).addComponent(textField_2,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(28)
				.addGroup(gl_contentPane
						.createParallelGroup(Alignment.BASELINE).addComponent(lblStudentName).addComponent(textField_3,
								GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(26)
