...
public class LibrarianForm extends JFrame {
	...
	public LibrarianForm() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			if(name.isEmpty() || password.isEmpty() || email.isEmpty() || address.isEmpty() || city.isEmpty() || contact.isEmpty()) {
				JOptionPane.showMessageDialog(LibrarianForm.this,"Field must not be empty !");
			}else {
				int i=dao.save(name, password, email, address, city, contact);
				if(i>0){
